...
public class LoggerFactory {
	...
	public static void main(String[] args) {
		...
		Logger logger = getLogger("nikos");
		Logger logger2 = getLogger("nikos2");
		...
		Logger log1 = LoggerFactory.getIndependentLogger("xxx", Level.INFO, "/apps/homefs1/nsarkas/test1.log");
		log1.info("test");
		Logger log2 = LoggerFactory.getIndependentLogger("xxx", Level.INFO, "/apps/homefs1/nsarkas/test1.log");
		log2.info("test");
	}
}

...
if __name__ == "__main__":
    #key = paramiko.RSAKey.from_private_key_file("/apps/homefs1/nsarkas/.ssh/id_rsa")
    source = NewsScopeSFTPSource("infradaemon15.jc","ase",None, 5)
    source.cwd("/spare/local/NewsScope/data")
    files = source.list(r".*")
    for file in files:
        print file
